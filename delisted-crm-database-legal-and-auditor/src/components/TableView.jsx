                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3 max-w-[220px]">
                        ...
                        {issuer.auditor && issuer.auditor !== "Not Available" && (
                          <div className="flex items-center gap-1 text-[10px] text-amber-400/90 truncate mt-0.5">
                            <ClipboardCheck className="h-2.5 w-2.5 shrink-0" />
                            <span className="truncate">{typeof issuer.auditor === "string" ? issuer.auditor : issuer.auditor.firmName}</span>
                          </div>
                        )}
                        {issuer.nomad && (
