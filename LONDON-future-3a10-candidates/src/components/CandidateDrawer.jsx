      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            ...
            <div className="text-sm font-mono font-bold text-white mt-0.5">{candidate.lastPriceGbp}</div>
          </div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            <div className="text-[10px] text-slate-400 uppercase font-semibold">Market Cap</div>
            <div className="text-sm font-mono font-bold text-white mt-0.5">{candidate.marketCapGbp}</div>
          </div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            <div className="text-[10px] text-slate-400 uppercase font-semibold">VWAP Discount</div>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">UK Statutory Procedure</h3>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-3 text-xs">
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              ...
              <span className="font-semibold text-emerald-400">{candidate.mechanism}</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
            ...
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              <span className="text-slate-400">Court Hearing Date:</span>
              <span className="font-mono font-bold text-white">{candidate.hearingDate}</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              <span className="text-slate-400">Restructuring Debt Size:</span>
              <span className="font-mono font-bold text-emerald-300">{candidate.claimOrDealValue}</span>
            </div>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Restructuring Counsel & Funder</h3>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-2.5 text-xs">
            <div className="flex items-center gap-2 text-slate-300">
              <Shield className="w-4 h-4 text-emerald-400" />
              <span>Restructuring Counsel: <strong className="text-white">{candidate.administratorOrCounsel}</strong></span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
        ...
        <div className="space-y-2">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Analysis & High Court Rationale</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Board Leadership & Investor Relations</h3>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-2 text-xs">
            <div className="font-semibold text-slate-200">Executive Chair / CEO: {candidate.executiveChair}</div>
        ...
        <div className="pt-4 border-t border-slate-800 flex gap-3">
          ...
          >
            ...
            Send Scheme Recapitalization Pitch
          </button>
          <a
