...
export default function RestructuringTable({ candidates, onSelect, onOpenEmail }) {
  const getMechanismBadge = (mechanism) => {
    if (mechanism.includes('Part 26A')) {
      return 'bg-emerald-500/15 text-emerald-400 border-emerald-500/30';
    }
    if (mechanism.includes('Part 26 Scheme')) {
  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-slate-800 bg-[#0d1424]/60 shadow-xl">
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-slate-800 bg-slate-900/80 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
            <th className="py-3 px-4">TIDM / Ticker</th>
            ...
            <th className="py-3 px-4">Restructuring Debt Value</th>
              ...
              <td className="py-3.5 px-4 font-medium text-slate-200">
                <div className="flex items-center gap-1.5">
                  ...
                  {c.urgentActionRequired && (
                    <span className="flex h-2 w-2 relative" title="High Court Hearing Imminent">
              ...
              <td className="py-3.5 px-4 text-right whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-end gap-1.5">
                  <button
                    ...
                    title="Send Scheme Recapitalization Pitch"
                  >
                  ...
                  <a
                    ...
                    title="View London Stock Exchange Page"
                  >
