  ...
  return (
    <header className="border-b border-slate-800 bg-[#0d1322]/90 backdrop-blur-md sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono hidden xs:inline">ASX / ASIC Restructuring</span>
              </div>
              <h1 className="text-xs sm:text-base font-bold text-white tracking-tight flex items-center gap-2 truncate max-w-[200px] xs:max-w-[280px] sm:max-w-none">
                Scheme (s411) & DOCA 3(a)(10) Candidates
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              title="Open Deal Math Calculator"
            >
            ...
            <button
              ...
              title="Sync ASIC & ASX Court Hearings"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-emerald-400' : ''}`} />
              <span className="hidden md:inline">{isSyncing ? 'Syncing...' : 'Sync ASIC'}</span>
            </button>
        ...
        {/* Mobile View Switcher Tabs (visible on mobile / tablet) */}
