        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono hidden xs:inline">ASX / NSX Shells</span>
              </div>
              <h1 className="text-xs sm:text-base font-bold text-white tracking-tight flex items-center gap-2 truncate max-w-[200px] xs:max-w-[280px] sm:max-w-none">
                Suspended & Delisted Entities CRM
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              title="Sync Live ASX Suspensions"
            >
