...
import { Mail, ChevronRight, Scale, ShieldCheck, Clock, FileText } from 'lucide-react';
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-slate-800 bg-slate-900/80 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
            <th className="py-3 px-4">Ticker / FWB</th>
            <th className="py-3 px-4">Company Name & ISIN</th>
            <th className="py-3 px-4">Segment / Delisting Trigger</th>
            <th className="py-3 px-4">Clean Shell Score</th>
            <th className="py-3 px-4">Insolvenzverwalter / Counsel</th>
            ...
            >
              ...
              <td className="py-3.5 px-4 font-mono font-bold text-rose-400 whitespace-nowrap">
                ...
                <div className="text-[10px] text-slate-500 font-sans mt-0.5">
                  {i.lastPriceEur} | MC: {i.marketCapAtSuspension}
                </div>
              </td>
              ...
              <td className="py-3.5 px-4 font-medium text-slate-200">
                ...
                <div className="text-[10px] text-slate-400 truncate max-w-[200px] mt-0.5 font-mono">
                  ISIN: {i.isin} (WKN: {i.wkn})
                </div>
              </td>

              {/* Segment */}
              <td className="py-3.5 px-4">
                <div className="font-semibold text-slate-300">{i.segment}</div>
                <div className="text-[10px] text-slate-500 truncate max-w-[180px]">{i.delistingReason}</div>
              </td>
              ...
              <td className="py-3.5 px-4 text-slate-300">
                <div className="text-xs text-slate-200 font-medium truncate max-w-[170px]">{i.insolvenzverwalter}</div>
                <div className="text-[10px] text-slate-500 truncate max-w-[170px]">{i.legalCounsel}</div>
              </td>
