      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-4 flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-slate-400 mt-0.5">{issuer.shellRating}</div>
          </div>
          <div className="text-right">
            <span className="text-2xl font-bold font-mono text-emerald-400">{issuer.cleanShellScore}</span>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            ...
            <div className="text-sm font-mono font-bold text-white mt-0.5">{issuer.lastPriceEur}</div>
          </div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
        ...
        {/* Legal Counsel & Insolvency Practitioner */}
        <div className="space-y-3">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Insolvency Administrator & Counsel</h3>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-2.5 text-xs">
            <div className="flex items-center gap-2 text-slate-300">
              <Scale className="w-4 h-4 text-rose-400" />
              <span>Insolvenzverwalter: <strong className="text-white">{issuer.insolvenzverwalter}</strong></span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
              <Shield className="w-4 h-4 text-amber-400" />
              <span>Legal Restructuring Counsel: <strong className="text-white">{issuer.legalCounsel}</strong></span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
              <Building className="w-4 h-4 text-slate-400" />
              <span>Share Custodian / Registry: <strong className="text-white">{issuer.shareRegistry}</strong></span>
            </div>
          </div>
        </div>
        ...
        {/* Corporate Details */}
        <div className="space-y-2">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Shell Background & Asset Profile</h3>
        ...
        <div className="pt-4 border-t border-slate-800 flex gap-3">
          ...
          >
            ...
            Send Shell Acquisition Inquiry
          </button>
        </div>
      </div>
    </div>
