...
import { Database, Table, Kanban, Scale, BarChart3, Download, RefreshCw } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono hidden xs:inline">FWB / AG-Mäntel CRM</span>
              </div>
              <h1 className="text-xs sm:text-base font-bold text-white tracking-tight flex items-center gap-2 truncate max-w-[200px] xs:max-w-[280px] sm:max-w-none">
                Suspended & Delisted AG-Mäntel CRM
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              title="Sync Live FWB Suspensions & Handelsregister"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-rose-400' : ''}`} />
              <span className="hidden md:inline">{isSyncing ? 'Syncing...' : 'Sync FWB'}</span>
            </button>
