...
import { TrendingUp, UserCheck, ExternalLink, ChevronRight } from 'lucide-react';

export default function DirectorsDealingsView({ signals, onSelect }) {
  const trades = signals.filter((s) => s.signalType.includes('MAR'));
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-slate-800 bg-slate-900/80 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
            ...
            <th className="py-3 px-4">Management & Role (*Vorstand/Aufsichtsrat*)</th>
            <th className="py-3 px-4">Trade Value (€EUR)</th>
            <th className="py-3 px-4">Price / Volume</th>
            ...
            >
              ...
              <td className="py-3.5 px-4 font-mono font-bold text-purple-400 whitespace-nowrap">
                ...
                <div className="text-[10px] text-slate-500 font-sans mt-0.5">
                  {s.lastPriceEur} | MC: {s.marketCapEur}
                </div>
              </td>
              ...
              <td className="py-3.5 px-4 text-right whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-end gap-1.5">
                  <a
                    ...
                    title="View BaFin Directors' Dealings"
                  >
