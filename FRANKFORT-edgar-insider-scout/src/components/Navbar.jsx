        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono hidden xs:inline">Art. 19 MAR & WpHG Signals</span>
              </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              title="Sync BaFin & EQS Directors' Dealings"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-purple-400' : ''}`} />
              <span className="hidden md:inline">{isSyncing ? 'Syncing...' : 'Sync BaFin'}</span>
            </button>
