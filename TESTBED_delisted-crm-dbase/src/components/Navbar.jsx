  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-[#1B2030] bg-[#0A0C10]/95 backdrop-blur-md">
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-[11px] text-[#8892A6] line-clamp-1">
                {totalCount} Delisted Issuers • Public SEC EDGAR Officers & Legal Counsel Contacts
              </p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex flex-1 max-w-md mx-4">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search ticker, company, counsel, CIK, CEO..."
                value={searchTerm}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">Outreach Runner</span>
            </button>
        ...
        <div className="px-4 py-2 border-t border-[#1B2030]/50 lg:hidden">
          <div className="relative w-full">
            <Search className="absolute left-3 top-2.5 h-3.5 w-3.5 text-[#8892A6]" />
            <input
              type="text"
              placeholder="Search ticker, company, legal counsel, CIK..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
