...
import { X, ExternalLink, Mail, Phone, Building, Target, Shield, Calendar, DollarSign, TrendingUp, UserCheck } from 'lucide-react';
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="text-xs text-slate-400 mt-0.5">{signal.sector} | SEDOL: {signal.sedol}</div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            ...
            <div className="text-sm font-mono font-bold text-emerald-400 mt-0.5">{signal.totalValueGbp}</div>
          </div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
            <div className="text-[10px] text-slate-400 uppercase font-semibold">Share Price</div>
            <div className="text-sm font-mono font-bold text-white mt-0.5">{signal.lastPriceGbp}</div>
          </div>
          <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-3">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-3 text-xs">
            ...
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              ...
              <span className="text-slate-200 font-semibold">{signal.directorOrHolder} ({signal.positionRole})</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
            ...
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              <span className="text-slate-400">Signal Rationale:</span>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-2 text-xs">
            <div className="font-semibold text-slate-200">Company Secretary / Legal: {signal.companySecretary}</div>
        ...
        <div className="pt-4 border-t border-slate-800 flex gap-3">
          ...
          >
            ...
            View Official London RNS Notice
          </a>
        </div>
      </div>
    </div>
