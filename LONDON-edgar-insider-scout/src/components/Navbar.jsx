...
import { Target, TrendingUp, Users, Radar, BarChart3, Download, RefreshCw } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-tr from-purple-600 to-indigo-500 flex items-center justify-center shadow-lg shadow-purple-500/20 text-white font-bold flex-shrink-0">
            ...
            <div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono hidden xs:inline">UK MAR PDMRs & DTR 5 TR-1</span>
              </div>
              <h1 className="text-xs sm:text-base font-bold text-white tracking-tight flex items-center gap-2 truncate max-w-[200px] xs:max-w-[280px] sm:max-w-none">
                PDMR Dealings & Major Holdings Scout
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              title="Sync FCA & RNS TR-1 Feed"
            >
              <RefreshCw className={`w-3.5 h-3.5 ${isSyncing ? 'animate-spin text-purple-400' : ''}`} />
              <span className="hidden md:inline">{isSyncing ? 'Syncing...' : 'Sync TR-1 Feed'}</span>
            </button>
            ...
            <button
              ...
              title="Export Regulatory Signals"
            >
