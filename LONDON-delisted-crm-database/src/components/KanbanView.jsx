...
import { Mail, ChevronRight, Building, Clock } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-slate-800/80">
                    <span className="text-[10px] font-mono text-rose-400 flex items-center gap-1">
                      ...
                      {i.daysRemainingBeforeCancel > 0 ? `${i.daysRemainingBeforeCancel}d` : 'Cancelled'}
                    </span>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
