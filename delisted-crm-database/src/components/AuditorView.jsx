...
export default function AuditorView({ 
  ...
  // Group issuers by Auditor / Accounting Firm Name
  const firmMap = useMemo(() => {
    ...
    issuers.forEach((issuer) => {
      ...
      const firmKey = audName.trim() || "Not Available";
    ...
    // Compute average clean shell / opportunity score
  ...
  // Filtered and sorted accounting firms
    ...
    <div className="flex flex-col gap-6 animate-fadeIn pb-20 md:pb-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#1B2030] bg-[#0F1218] p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#8892A6]">
              {verifiedFirmsCount} Verified PCAOB & International Audit Firms representing {issuers.length} Delisted Public Issuers
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-sm">
          ...
          <input
            type="text"
            placeholder="Search by auditor name, ticker, or issuer..."
            value={searchTerm}
      ...
      <div className="grid grid-cols-1 gap-4">
        {filteredFirms.length === 0 ? (
          <div className="rounded-2xl border border-[#1B2030] bg-[#0F1218] p-12 text-center text-[#8892A6]">
            No independent auditor firms match your search term.
          </div>
        ) : (
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <a 
                                    ...
                                    title="View OTC Markets Profile"
                                  >
                                    {issuer.ticker}
                                  </a>
                                </div>
